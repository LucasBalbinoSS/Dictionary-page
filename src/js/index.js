                ...
                `
                    <div>
                        <div class="flex justify-between items-center">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-9 h-9 cursor-pointer hover:scale-110 transition-transform active:scale-95">
